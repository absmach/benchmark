...
- [Fan in](https://github.com/nmarcetic/mainflux-loadtest/scenarios/fan_in.bdl)
- [Fan out](https://github.com/nmarcetic/mainflux-loadtest/scenarios/fan_out.bdl)
...
- [x] Digitalocean Kubernetes cluster. Detailed report available [here](https://github.com/nmarcetic/mainflux-loadtest/reports/digitalocean)
- [] AWS EKS
- [] GCE Kubernetes
